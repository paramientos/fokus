...
class EncryptionService
{
    ...
    public function generatePassword(
        ...
        if ($includeUppercase && !preg_match('/[A-Z]/', $password)) $hasRequiredChars = false;
        if ($includeNumbers && !preg_match('/[0-9]/', $password)) $hasRequiredChars = false;
        if ($includeSymbols && !preg_match('/[^A-Za-z0-9]/', $password)) $hasRequiredChars = false;
