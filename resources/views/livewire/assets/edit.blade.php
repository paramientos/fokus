...
new class extends Component {
    ...
    public function mount(Asset $asset): void
    {
        ...
        $this->purchase_price = $asset->purchase_price ? (string) $asset->purchase_price : '';
    ...
    public function save(): void
    {
        ...
        $this->redirect('/assets/' . $this->asset->id);
    }
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-gray-600">Update asset information</p>
        </div>
        <div class="flex gap-3">
            <x-button icon="fas.eye" link="/assets/{{ $asset->id }}" class="btn-outline">
                View Asset
            </x-button>
    ...
    <x-form wire:submit="save">
        ...
        <div class="flex justify-end gap-3">
            <x-button link="/assets/{{ $asset->id }}" class="btn-outline">
                Cancel
            </x-button>
