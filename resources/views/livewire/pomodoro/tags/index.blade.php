...
<div>
    <div class="flex items-center justify-between mb-6">
        ...
        <x-button href="{{ route('pomodoro.tags.create') }}" wire:navigate icon="fas.plus" color="primary">New Tag</x-button>
    </div>
        ...
        @forelse($tags as $tag)
            <x-card class="p-4 flex flex-col gap-2">
                ...
                <div class="flex gap-2 mt-2">
                    <x-button href="{{ route('pomodoro.tags.edit', ['tag' => $tag->id]) }}" wire:navigate size="sm" icon="fas.edit" color="secondary">Edit</x-button>
