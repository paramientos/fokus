...
new class extends Livewire\Volt\Component {
    ...
    {
        // Kullanıcının üyesi olduğu veya sahibi olduğu workspace'leri getir
    ...
    public function createWorkspace()
    {
        ...
        // Oluşturan kişiyi otomatik olarak admin rolüyle ekle
...
<div>
    ...
    <div class="p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <x-button @click="$dispatch('open-modal', 'create-workspace-modal')" icon="fas.plus" class="btn-primary">
                Create Workspace
            </x-button>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        ...
                        <div class="card-actions justify-end mt-4">
                            <x-button link="/workspaces/{{ $workspace->id }}" icon="fas.arrow-right" class="btn-sm btn-outline">
                                Open
                            </x-button>
                            
                            @if($workspace->owner_id === auth()->id())
                                <x-button link="/workspaces/{{ $workspace->id }}/members" icon="fas.users" class="btn-sm">
                                    Manage Members
                                </x-button>
                            @endif
                        </div>
            ...
            @if($workspaces->isEmpty())
                <div class="col-span-full flex flex-col items-center justify-center py-12 bg-base-100 rounded-lg shadow-sm">
                    ...
                    <x-button @click="$dispatch('open-modal', 'create-workspace-modal')" icon="fas.plus" class="btn-primary mt-4">
                        Create Workspace
                    </x-button>
                </div>
            @endif
    ...
    <x-modal name="create-workspace-modal">
