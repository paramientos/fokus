...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/aras/projects/projecta/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/aras/projects/projecta/public/storage','logging.default','logging.deprecations.channel',
...
'mail.markdown.theme','mail.markdown.paths','mary.prefix','mary.route_prefix','mary.components.spotlight.class',
...
'mary.toogle-sidebar','mary.spotlight','mary.upload','sprints.export.csv','sprints.export.json','storage.local',);
        registerArgumentsSet('views', 
'components.layouts.app','livewire.auth.login','livewire.auth.logout','livewire.auth.register','livewire.board.index',
'livewire.pages.dashboard','livewire.profile.index','livewire.projects.create','livewire.projects.index','livewire.projects.show',
'livewire.sprints.board','livewire.sprints.burndown','livewire.sprints.calendar','livewire.sprints.create','livewire.sprints.edit',
'livewire.sprints.index','livewire.sprints.report','livewire.sprints.retrospective','livewire.sprints.show','livewire.tasks.create',
'livewire.tasks.index','livewire.tasks.show','livewire.users.index','volt-livewire::auth.login','volt-livewire::auth.logout',
'volt-livewire::auth.register','volt-livewire::board.index','volt-livewire::pages.dashboard','volt-livewire::profile.index','volt-livewire::projects.create',
'volt-livewire::projects.index','volt-livewire::projects.show','volt-livewire::sprints.board','volt-livewire::sprints.burndown','volt-livewire::sprints.calendar',
'volt-livewire::sprints.create','volt-livewire::sprints.edit','volt-livewire::sprints.index','volt-livewire::sprints.report','volt-livewire::sprints.retrospective',
'volt-livewire::sprints.show','volt-livewire::tasks.create','volt-livewire::tasks.index','volt-livewire::tasks.show','volt-livewire::users.index',
